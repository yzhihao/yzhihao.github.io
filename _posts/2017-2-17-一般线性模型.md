...
<img src="{{ site.img_path }}/Machine Learning/logic_R1" alt="header1" style="height:auto!important;width:auto%;max-width:1020px;"/>

Sigmoid 函数在有个很漂亮的“S”形，如下图所示（引自维基百科）：

<img src="{{ site.img_path }}/Machine Learning/logic_R2" alt="header1" style="height:auto!important;width:auto%;max-width:1020px;"/>
...
<img src="{{ site.img_path }}/Machine Learning/logic_R3" alt="header1" style="height:auto!important;width:auto%;max-width:1020px;"/>

我将这两个式子结合一下：


<img src="{{ site.img_path }}/Machine Learning/logic_R4" alt="header1" style="height:auto!important;width:auto%;max-width:1020px;"/>


取似然函数为：

<img src="{{ site.img_path }}/Machine Learning/logic_R5" alt="header1" style="height:auto!important;width:auto%;max-width:1020px;"/>


对数似然函数为：

<img src="{{ site.img_path }}/Machine Learning/logic_R6" alt="header1" style="height:auto!important;width:auto%;max-width:1020px;"/>
...
<img src="{{ site.img_path }}/Machine Learning/logic_R7" alt="header1" style="height:auto!important;width:auto%;max-width:1020px;"/>



<img src="{{ site.img_path }}/Machine Learning/logic_R8" alt="header1" style="height:auto!important;width:auto%;max-width:1020px;"/>
...
<img src="{{ site.img_path }}/Machine Learning/logic_R9" alt="header1" style="height:auto!important;width:auto%;max-width:1020px;"/>
...
<img src="{{ site.img_path }}/Machine Learning/logic_R10" alt="header1" style="height:auto!important;width:auto%;max-width:1020px;"/>

接下来得到对数似然函数函数为:

<img src="{{ site.img_path }}/Machine Learning/logic_R11" alt="header1" style="height:auto!important;width:auto%;max-width:1020px;"/>
...
<img src="{{ site.img_path }}/Machine Learning/logic_R12" alt="header1" style="height:auto!important;width:auto%;max-width:1020px;"/>
...
<img src="{{ site.img_path }}/Machine Learning/logic_R13" alt="header1" style="height:auto!important;width:auto%;max-width:1020px;"/>
...
<img src="{{ site.img_path }}/Machine Learning/logic_R14" alt="header1" style="height:auto!important;width:auto%;max-width:1020px;"/>
...
<img src="{{ site.img_path }}/Machine Learning/logic_R15" alt="header1" style="height:auto!important;width:auto%;max-width:1020px;"/>
...
<img src="{{ site.img_path }}/Machine Learning/logic_R16" alt="header1" style="height:auto!important;width:auto%;max-width:1020px;"/>
...
<img src="{{ site.img_path }}/Machine Learning/logic_R17" alt="header1" style="height:auto!important;width:auto%;max-width:1020px;"/>

当参数θ只有一个时，牛顿方法的迭代规则：

<img src="{{ site.img_path }}/Machine Learning/logic_R18" alt="header1" style="height:auto!important;width:auto%;max-width:1020px;"/>

当参数θ不止一个时，牛顿方法的迭代规则：

<img src="{{ site.img_path }}/Machine Learning/logic_R19" alt="header1" style="height:auto!important;width:auto%;max-width:1020px;"/>
